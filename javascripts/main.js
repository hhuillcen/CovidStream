...
var fileList = ["CovidStream", "CovidStreamEnero", "CovidStreamFebrero", "CovidStreamMarzo", "CovidStreamAbril", "CovidStreamMayo", "CovidStreamJunio", "CovidStreamJulio"]

var initialDataset = "CovidStream";
var categories = ["person", "location", "organization", "emotions"];
...
// =============== Get BOUNDARY and LAYERPATH ===============
    ...
    if (fileName.indexOf("Huffington") >= 0) {
        d3.json("data/linksHuff2012.json", function (error, rawLinks) {
            ...
            var isRel = document.getElementById("av").checked;
